...
--(B.B1_PER_GROUP || '/' || B.B1_PER_TYPE || '/' || B.B1_PER_SUB_TYPE || '/' || B.B1_PER_CATEGORY) AS RECORD_TYPE_COUNT,
  ...
  --INSPECTIONS
     ...
     ,G.G6_DOC_DES                AS INSPECTION_DISP
  ...
  --OR
  --(G.G6_ACT_DD >= TO_DATE('08/01/2017','MM/DD/YYYY')
  --and G.G6_ACT_DD < TO_DATE('08/04/2017','MM/DD/YYYY') + 1))
  --and rownum < 51
