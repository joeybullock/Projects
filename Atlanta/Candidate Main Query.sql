...
-- Edited by: Joey Bullock
-- Date: 2017-08-29
-- Fixed Zoning and Sign Attributes subquery.  Added contact phone numbers in subquery.
--======================================
	B.SERV_PROV_CODE, 
    B.B1_PER_ID1, 
    B.B1_PER_ID2, 
   ...
   (
	...
	(
		...
		WHERE
			...
			AND BCBS.B1_CHECKBOX_TYPE = 'ZONING' AND BCBS.B1_CHECKBOX_DESC = 'Zoning 1'
	) Zoning,
	(
		SELECT BCBS.B1_CHECKLIST_COMMENT
		FROM BCHCKBOX BCBS
